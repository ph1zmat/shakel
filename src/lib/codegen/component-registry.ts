...
export type { StyleConfig, StyleValue }

// Re-export from shared types for backwards compatibility
export type {
	StyleConfig as SharedStyleConfig,
	StyleValue as SharedStyleValue,
} from '@/types/builder'
...
export const componentRegistry: Record<string, ComponentDefinition> = {
	...
	icon: {
		...
		category: 'media',
		label: 'Icon',
		description: 'Tabler icon with customizable size and color',
		icon: 'Star',
		isContainer: false,
		props: [
			{
			...
			},
			{
				...
				label: 'Size',
				type: 'number',
				schema: z.number().min(12).max(128),
				defaultValue: 24,
			},
			{
				name: 'strokeWidth',
		...
		imports: ['@tabler/icons-react'],
		componentName: 'TablerIcon',
		platforms: ['web'],
	},
	...
	group: {
		...
		category: 'layout',
		label: 'Group',
		description: 'A container for grouping multiple components',
		icon: 'Folder',
		isContainer: true,
		props: [
			{
